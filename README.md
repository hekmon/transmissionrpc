...
This lib follows the [transmission v16 RPC specification](https://github.com/transmission/transmission/blob/3.00/extras/rpc-spec.txt#L806) (introduced with Transmission 3.00). It should be backward compatible with RPC v15 specification (introduced with Transmission 2.80) with almost all methods excepting the new [`SessionArgumentsGet()`](https://pkg.go.dev/github.com/hekmon/transmissionrpc@v2.0.0#Client.SessionArgumentsGet) method (use the backward compatible [`SessionArgumentsGetAll()`](https://pkg.go.dev/github.com/hekmon/transmissionrpc@v2.0.0#Client.SessionArgumentsGetAll) method in that case).
